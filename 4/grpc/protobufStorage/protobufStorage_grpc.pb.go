...
func (c *pGCClient) Put(ctx context.Context, in *Todo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *pGCClient) Commit(ctx context.Context, in *Todo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedPGCServer) Put(context.Context, *Todo) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Put not implemented")
}
func (UnimplementedPGCServer) Get(context.Context, *Todo) (*TodoStorage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
func (UnimplementedPGCServer) Commit(context.Context, *Todo) (*emptypb.Empty, error) {
